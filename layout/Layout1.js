...
<nav className="navbar navbar-light bg-white">
 ...
 {info.snap?<a href={info.snap} className="icon  p-1 github">
  ...
  <span className="ppp">Alhanouf</span>
...
<nav className={`navbar navbar-expand-lg z10 navbar-light bg-wight ${styles.navmob}`}>
  ...
  <button className="btn btn-mov text-white btn-sm"onClick={onncal} >للتواصل </button> 
...
{/* --------------------------------------------------------------------------------------------------- */}
{children}
<div className={`p-3 bgasd1 ${styles.footerx}`}>
